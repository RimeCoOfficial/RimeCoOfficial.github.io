...
<div class="mdl-grid">
    ...
    <div class="mdl-cell mdl-cell--6-col-desktop mdl-cell--5-col-tablet mdl-cell--4-col-phone">
        ...
        <h3>
            ...
            <a class="mdl-typography--font-light" href="<?php echo base_url('@suvozit'); ?>" target="_blank">
        ...
        <h3 class="">
            ...
            <a class="mdl-typography--font-light" href="<?php echo base_url('@girish'); ?>" target="_blank">
                <i class="material-icons">open_in_new</i>
            </a>
        </h3>
        <p>
